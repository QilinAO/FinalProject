// ======================================================================
// File: src/Component/ManagerLayout.jsx
// หน้าที่: จัดการโครงสร้าง Layout หลักสำหรับส่วนของผู้จัดการ (Manager)
// ======================================================================
...
/**
 * Layout หลักสำหรับหน้าทั้งหมดในส่วนของผู้จัดการ
 * ประกอบด้วยเมนู Manager และพื้นที่สำหรับแสดงเนื้อหาของแต่ละหน้า (Outlet)
 */
const ManagerLayout = () => {
